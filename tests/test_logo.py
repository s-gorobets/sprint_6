...
@allure.title("Rлик по логотипу Яндекса открывает Дзен")
...
@allure.title("Rлик по логотипу Cамоката открывает главную страницу")
def test_logo_scooter_retur_main(driver):
